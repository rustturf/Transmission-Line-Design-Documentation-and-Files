...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth,angle=-270]{Figures/GMDD.pdf}
...
\begin{align*}
    ...
    C&=2*10^{-7}*\left(\frac{1}{ln\frac{6.370}{0.3467}}\right)=6.870*10^{-8}F/phase\ m=6.870*10^{-5}F/phase \ km
\end{align*}
\end{document}